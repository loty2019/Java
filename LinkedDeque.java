...
public class LinkedDeque<Item> implements Iterable<Item> {
    Node first; // refers to the front of the deque
    Node last; // refers to the back of the deque
    ...
    public void addFirst(Item item) {
        ...
        newNode.next = first;
        n++;
        if (n == 1) { // if its the first item first and last have to point to the same node
            first = newNode;
            last = first;
        } else {
            first.prev = newNode;
    ...
    public void addLast(Item item) {
        ...
        newNode.prev = last;
        n++;
        if (last == null) { // If this's the first add, first and last must point to the same node
            first = newNode;
            last = first;
        } else {
            last.next = newNode;
    ...
    private class DequeIterator implements Iterator<Item> {
        Node current; // refers to the current Node in the iterator
